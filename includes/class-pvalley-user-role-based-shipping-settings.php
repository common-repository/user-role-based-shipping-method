			...
			switch( $current_section) {
				...
				default :
					$settings = array(
						...
						"general_settings_hide_shipping_methods"  => array(
							"name"      => __("Hide shipping methods", "pvalley-user-role-based-shipping"),
							"type"      => "select",
							"options"   => array(
								"" => __("Select"),
								"free_shipping" => __("Show Free Shipping Only, hide other shipping methods", "pvalley-user-role-based-shipping")
							),
							"class"     => "wc-enhanced-select",
							"id"        => "pvalley_user_role_based_shipping[show_only]",
							"desc"      => "It will be applied only if Free Shipping is available during checkout. It's not related to rule matrix. It can be used without rule matrix."
						),
