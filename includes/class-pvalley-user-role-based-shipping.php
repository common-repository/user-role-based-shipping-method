...
if( ! class_exists('Pvalley_User_Role_Based_Shipping') ) {
	...
	final class Pvalley_User_Role_Based_Shipping {
		...
		public function __construct(){
			...
			// Compatibility with High Performance order storage feature of WooCommerce
			add_action('before_woocommerce_init', array($this, 'hposCompatibility'));
		}

		/**
		 * High performance order storage feature compatibility.
		 *
		...
		public function hposCompatibility( ) {
			if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
				\Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', PVALLEY_URBS_PLUGIN_FILE, true );
			}
		}
